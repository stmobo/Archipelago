...
AVAIL_MAP = {
    ...
    0x0A: {EIRIKA, SETH, GILLIAM, FRANZ, MOULDER, VANESSA, ROSS, NEIMI, COLM, GARCIA, LUTE, NATASHA, FORDE, KYLE, ARTUR, JOSHUA},
    0x0B: {EIRIKA, SETH, GILLIAM, FRANZ, MOULDER, VANESSA, ROSS, NEIMI, COLM, GARCIA, LUTE, NATASHA, FORDE, KYLE, ARTUR, JOSHUA, TANA},
    0x0C: {EIRIKA, SETH, GILLIAM, FRANZ, MOULDER, VANESSA, ROSS, NEIMI, COLM, GARCIA, INNES, LUTE, NATASHA, FORDE, KYLE, ARTUR, GERIK, TETHYS, MARISA, LARACHEL, DOZLA, JOSHUA, TANA},
    0x0D: {EIRIKA, SETH, GILLIAM, FRANZ, MOULDER, VANESSA, ROSS, NEIMI, COLM, GARCIA, INNES, LUTE, NATASHA, FORDE, KYLE, ARTUR, GERIK, TETHYS, MARISA, SALEH, EWAN, LARACHEL, DOZLA, JOSHUA, TANA},
    0x0E: {EIRIKA, SETH, GILLIAM, FRANZ, MOULDER, VANESSA, ROSS, NEIMI, COLM, GARCIA, INNES, LUTE, NATASHA, CORMAG, FORDE, KYLE, AMELIA, ARTUR, GERIK, TETHYS, MARISA, SALEH, EWAN, LARACHEL, DOZLA, JOSHUA, TANA},
    0x0F: {EIRIKA, SETH, GILLIAM, FRANZ, MOULDER, VANESSA, ROSS, NEIMI, COLM, GARCIA, INNES, LUTE, NATASHA, CORMAG, FORDE, KYLE, AMELIA, ARTUR, GERIK, TETHYS, MARISA, SALEH, EWAN, LARACHEL, DOZLA, RENNAC, JOSHUA, TANA},
    ...
    0x3D: {EIRIKA, SETH, GILLIAM, FRANZ, MOULDER, VANESSA, ROSS, NEIMI, COLM, GARCIA, INNES, LUTE, NATASHA, FORDE, KYLE, ARTUR, GERIK, TETHYS, MARISA, JOSHUA, TANA},
